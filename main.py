...
def build_loader(config):
    ...
    if not config['test']:
        # Initializes train and val sets
        ...
        # Creates train dataloader from dataset_type for pc_dataset
